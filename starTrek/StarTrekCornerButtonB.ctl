VERSION 5.00
Begin VB.UserControl StarTrekCornerButtonB 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00000000&
   ClientHeight    =   3600
   ClientLeft      =   0
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   320
   ToolboxBitmap   =   "StarTrekCornerButtonB.ctx":0000
   ...
   End
End
Attribute VB_Name = "StarTrekCornerButtonB"
...
On Error Resume Next
    ...
    If State = Normal Then
        ...
        Line (LFTLNW / 2 - 1, HG)-(WD, HG - TOPLNW), BC, BF
        Line (0, HG - LFTLNW / 2 - 1)-(LFTLNW, 0), BC, BF
    ...
    ElseIf State = Hover Then
        For i = LFTLNW / 2 To LFTLNW * 1.5
            Circle (i, HG - LFTLNW / 2), LFTLNW / 2, BCH, 3.14, 1.5 * 3.14
        Next i
        For i = LFTLNW / 2 To TOPLNW + LFTLNW / 2
            Circle (LFTLNW * 1.5, HG - i), LFTLNW / 2, BCH, 3.14, 1.5 * 3.14
        Next i
        
        Line (LFTLNW / 2 - 1, HG)-(WD, HG - TOPLNW), BCH, BF
        Line (0, HG - LFTLNW / 2 - 1)-(LFTLNW, 0), BCH, BF
    ...
    Else
        For i = LFTLNW / 2 To LFTLNW * 1.5
            Circle (i, HG - LFTLNW / 2), LFTLNW / 2, BCD, 3.14, 1.5 * 3.14
        Next i
        For i = LFTLNW / 2 To TOPLNW + LFTLNW / 2
            Circle (LFTLNW * 1.5, HG - i), LFTLNW / 2, BCD, 3.14, 1.5 * 3.14
        Next i
        
        Line (LFTLNW / 2 - 1, HG)-(WD, HG - TOPLNW), BCD, BF
        Line (0, HG - LFTLNW / 2 - 1)-(LFTLNW, 0), BCD, BF
