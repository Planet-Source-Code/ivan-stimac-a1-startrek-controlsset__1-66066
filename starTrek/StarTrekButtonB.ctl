VERSION 5.00
Begin VB.UserControl StarTrekButtonB 
   AutoRedraw      =   -1  'True
   ClientHeight    =   1950
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   320
   ToolboxBitmap   =   "StarTrekButtonB.ctx":0000
   ...
   End
End
Attribute VB_Name = "StarTrekButtonB"
...
On Error Resume Next
    ...
    ElseIf State = Hover Then
        For i = HG / 2 To HG * 1.5
            Circle (i, HG / 2), HG / 2, BCH, (3.14 / 2), ((3 / 2) * 3.14)
        Next i
    ...
    Else
        For i = HG / 2 To HG * 1.5
            Circle (i, HG / 2), HG / 2, BCD, (3.14 / 2), ((3 / 2) * 3.14)
        Next i
