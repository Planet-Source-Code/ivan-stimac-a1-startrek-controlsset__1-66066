VERSION 5.00
Begin VB.UserControl StarTrekLabelB 
   AutoRedraw      =   -1  'True
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   320
   ToolboxBitmap   =   "StarTrekLabelB.ctx":0000
   ...
   End
End
Attribute VB_Name = "StarTrekLabelB"
